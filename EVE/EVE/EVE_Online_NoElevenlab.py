...
class EVE:
    def __init__(self):
        ...
        self.system_behavior = """
            Your name is EVE, which stands for Advanced Design Assistant.
...
async def main():
    ...
    if eve.pya is None or eve.recorder is None or eve.stream is None:
    ...
    tasks = [
        ...
        asyncio.create_task(eve.tts()),          # response_queue -> RealtimeTTS (feed + play_async)
    ...
    try:
        ...
        print("Main tasks cancelled.")
         ...
         if eve.stream:
             ...
             eve.stream.stop() # Ensure TTS stream is stopped
         for task in tasks:
         ...
         if eve.pya:
              ...
              await asyncio.to_thread(eve.pya.terminate)
